...
<body>
              ...
              <form class="pt-3"  id="register">
                ...
                <div class="form-group">
                  <select class="form-control form-control-lg" name="country" id="exampleFormControlSelect2">
                    <option value="">Abroad Education Country</option>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="<?= base_url('welcome') ?>" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
  ...
  <script src="<?= base_url() ?>asset/js/register.js"></script>
